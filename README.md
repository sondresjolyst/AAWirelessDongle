...
Once the car recognizes the device and sends a request to start Android Auto, bluetooth is enabled. On your phone, open Bluetooth settings and pair a new device called "AndroidAuto". Once paired, it should automatically start the Wireless Android Auto on the car screen.
